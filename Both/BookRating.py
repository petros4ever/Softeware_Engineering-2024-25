...
class BookRatingApp(MDApp):
    def build(self):
        ...
        self.sm.add_widget(BookSearchScreen(name='search'))
        self.sm.add_widget(RatingFormScreen(name='rating_form'))
